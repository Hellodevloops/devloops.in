...
if(isset($_POST['submit'])){
    $firstName= $_POST['hireUsFormNameFirstName'];
    $lastName= $_POST['hireUsFormNameLastName'];
    $mailForm = $_POST['hireUsFormNameWorkEmail'];
    $mailTo = "24richavaidya@gmail.com";
    $headers = "From:  ".$mailFrom;
    $txt = "You have a message " . $firstName . ".\n\n" . $message;

    mail($mailTo , $firstName, $txt, $headers);

    header("Location: index1.html?MessageSent");
...
<!-- Mirrored from htmlstream.com/preview/front-v4.3.1/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 May 2023 06:20:15 GMT -->
...
<head>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" href="./assets/img/infinite.png">
...
<body>
  ...
  <div class="container content-space-t-1">
    <nav class="js-mega-menu navbar-nav-wrap ">
      ...
      <a class="navbar-brand" aria-label="Front">
        <img class="navbar-brand-logo" src="./assets/img/newlogobg.png" alt="Logo" style="width: 250px; height:40px;">
      </a>
        ...
        <div class="navbar-absolute-top-scroller">
          <ul class="navbar-nav">
            ...
            <li class="hs-has-sub-menu nav-item">
              <a id="pagesMegaMenu" class="hs-mega-menu-invoker   text-dark  nav-link" href="./index1.html" role="button" aria-expanded="false">Home</a>

              <!-- Mega Menu -->
              <div class="hs-sub-menu " aria-labelledby="companyMegaMenu" style="min-width: 14rem;">
            ...
            <!-- Account -->
            <li class="hs-has-sub-menu nav-item">
              <a id="pagesMegaMenu" class="hs-mega-menu-invoker   text-dark  nav-link" href="./about.html" role="button" aria-expanded="false">About</a>
            ...
            <li class="hs-has-sub-menu nav-item">
              ...
              <div class="hs-sub-menu dropdown-menu" aria-labelledby="pagesMegaMenu" style="min-width: 14rem;">
                <a class="dropdown-item text-dark " href="./product.html">Product Development</a>
                <a class="dropdown-item text-dark" href="./web.html">Web Development </a>
                <a class="dropdown-item text-dark" href="./iot.html">IOT</a>
            ...
            <li class="hs-has-sub-menu nav-item">
              <a id="pagesMegaMenu" class="hs-mega-menu-invoker   text-dark  nav-link" href="./career.html" role="button" aria-expanded="false">Career</a>
            ...
            <!-- Blog -->
            <li class="hs-has-sub-menu nav-item">
              <a id="pagesMegaMenu" class="hs-mega-menu-invoker   text-dark  nav-link" href="./contact.html" role="button" aria-expanded="false">Contact</a>
  ...
  <main id="content" role="main" class="bg-dark">
    <!-- Hero -->
    <div class="position-relative bg-dark " style="background-image: url(assets/svg/components/card-11.svg);">
    ...
    <!-- Contact Form -->
    <div class="container content-space-t-1 content-space-t-lg-5 content-space-b-2 mb-3 mt-n12">
      <div class="text-center mb-10 mt-n5">
        <h2 class="text-white">Contact Us</h2>
        <h1 class="text-primary lead">Reach out to us and let's start a conversation. We're here to assist you every step of the way.</h1>
        ...
        <div class="row">
          <div class="col-lg-6 mb-9 mb-lg-0">
            <!-- Heading -->
            <div class="mb-5">
              <p class="text-white p1">Get in touch</p>
              <h2 class="text-primary">
                <img src="./assets/img/infinite.png" alt="Image Description" class="img-fluid inline-image" style="width: 80px; height: 80px;">
            ...
            <div class="row">
                  ...
                  <div class="card card-transition text-center h-100">
                    <a class="card card-transition text-center h-100" href="mailto:hr@devloops.in">
                      <div class="card-body">
                        ...
                        <p class="card-text text-body text-dark">Simple drop us an email at hr@devloops.in and you'll receive a reply within 24 hours</p>
                      </div>
              ...
              <div class="card-body">
                ...
                <p class="card-text text-body text-dark">Give us a ring.Our Experts are standing by monday to friday from 9am to 6pm.</p>
              </div>
                ...
                <div class="card-body">
                  ...
                  <form onsubmit="submitForm(event)">
                    <div class="row gx-3">
                      <div class="col-sm-6">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control form-control-lg" name="hireUsFormNameFirstName" id="hireUsFormFirstNameEg3" placeholder="First name" aria-label="First name" required>
                        </div>
                        <!-- End Form -->
                      </div>
                      <!-- End Col -->
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control form-control-lg" name="hireUsFormNameLastName" id="hireUsFormLasttNameEg3" placeholder="Last name" aria-label="Last name" required>
                        </div>
                        <!-- End Form -->
                      </div>
                      <!-- End Col -->
                    ...
                    <div class="row gx-3">
                      <div class="col-sm-6">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="email" class="form-control form-control-lg" name="hireUsFormNameWorkEmail" id="hireUsFormWorkEmailEg3" placeholder="email@site.com" aria-label="email@site.com" required>
                        </div>
                        <!-- End Form -->
                      </div>
                      <!-- End Col -->
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="tel" class="form-control form-control-lg" name="hireUsFormNamePhone" id="hireUsFormPhoneEg3" placeholder="+x(xxx)xxx-xx-xx" aria-label="+x(xxx)xxx-xx-xx">
                        </div>
                        <!-- End Form -->
                      </div>
                      <!-- End Col -->
                    ...
                    <div class="mb-3">
                      ...
                      <textarea class="form-control form-control-lg" name="hireUsFormNameDetails" id="hireUsFormDetails" placeholder="Tell us about your ..." aria-label="Tell us about your ..." rows="4" required></textarea>
                    </div>
                    <!-- End Form -->
                
                    <div class="d-grid">
                      <button type="submit" class="btn btn-outline-primary  btn-transition">Contact Us</button>
                    </div>
                  </form>
                  <!-- End Form -->
                </div>
  ...
  <section class="container-fluid my-1 mt-n12 mb-14">
    <div class="row">
        <div class="col-lg-12 p-0">
            ...
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3690.7245431381434!2d73.14561787344553!3d22.32625507966792!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395fc8ee3e155555%3A0x1386022b1d132240!2sDevloops%20International!5e0!3m2!1sen!2sus!4v1701242127098!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
  ...
  <!-- ========== FOOTER ========== -->
  <footer class="bg-dark mt-10" style="background-image: url(assets/svg/components/wave-pattern-light.svg);" >
    <div class="container content-space-t-2 content-space-b-1 mt-n8 ">
      <div class="row mb-9 " >
        <div class="col-lg-3 mb-5 mb-lg-0 mt-n8">
          <!-- Logo -->
          <a href="#home" aria-label="Front ">
            <img class="brand mt-8"  src="./assets/img/newlogobg.png" alt="Logo" style="width: 240px; height: 50px;">
          </a>
          <!-- End Logo -->
          <!-- List -->
        ...
        <div class="col-7 col-md-3 col-lg-2 mb-5 mb-md-0 text-white-70">
          ...
          <ul class="list-unstyled list-py-1 mb-0 text-white-70">
            <li><a class="link-sm text-white" href="./index1.html">Home</a></li>
        ...
        <div class="col-6 col-md-3 col-lg-2 mb-5 mb-md-0">
          ...
          <ul class="list-unstyled list-py-1 mb-0">
            <li><a class="link-sm text-white" href="./product.html">Product Development</a></li>
...
<!-- Mirrored from htmlstream.com/preview/front-v4.3.1/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 May 2023 06:20:45 GMT -->
