...
@section('content')
    ...
    <main>
              ...
              <div class="row">
                       ...
                       <div class="tp-services-details-contact">
                          ...
                          <div class="tp-services-details-contact-item d-flex align-items-center">
                             ...
                             <div class="tp-services-details-contact-item-content">
                                ...
                                <a href="#">GF-2 Dhanlaxmi Complex, Subhanpura, Vadodara, Gujarat, India – 390023</a>
                             </div>
                          </div>
                       </div>
                    </div>
                 ...
                 <div class="col-lg-8">
                    <div class="tp-services-details-wrapper ml-30">
                       ...
                       <p class="text-black">
                          At <span class="text-pink">Devloops</span>, we understand the paramount importance of protecting user data and upholding the trust our customers place in our products. This fundamental principle drives our development practices, where security takes center stage. We implement a comprehensive approach to security, integrating cutting-edge encryption techniques,<span class="text-pink"> rigorous authentication protocols, and meticulous security audits into our processes</span>. By prioritizing these measures, we ensure that our users' data remains safeguarded against potential threats and vulnerabilities, bolstering confidence in the reliability and integrity of our solutions.
                       </p>
        ...
        <!-- sercices-area-end -->
        <section class="offering-area tp-offer-bg pb-80 pt-120 mb-80" data-background="assets/img/bg/offer-bg-1.jpg" style="background-image: url(&quot;assets/img/bg/offer-bg-1.jpg&quot;);">
           <div class="container">
                 ...
                 <div class="col-xl-4 col-lg-3 col-md-6">
                    <div class="tp-offer-item mb-40 wow bounceIn" data-wow-duration=".6s" data-wow-delay=".6s" style="visibility: visible; animation-duration: 0.6s; animation-delay: 0.6s; animation-name: bounceIn;">
                       ...
                       <div class="tp-offer-item-content">
                          ...
                          <p>Enterprise Resource Planning (ERP) streamlines business processes by integrating and managing core functions such as finance and human resources.</p>
                       </div>
                 ...
                 <div class="col-xl-4 col-lg-3 col-md-6">
                    <div class="tp-offer-item mb-40 wow bounceIn" data-wow-duration=".5s" data-wow-delay=".5s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.5s; animation-name: bounceIn;">
                       ...
                       <div class="tp-offer-item-content">
                          ...
                          <p>Customer Relationship Management (CRM) <br>focuses on enhancing customer interactions, providing tools to manage leads & automate sales processes.</p>
                       </div>
                       <!-- <div class="tp-offer-item-btn">
                          <a href="services-details.html">Read More <i class="fa-regular fa-arrow-right"></i></a>
                       </div> -->
                 ...
                 <div class="col-xl-4 col-lg-3 col-md-6">
                    <div class="tp-offer-item mb-40 wow bounceIn" data-wow-duration=".6s" data-wow-delay=".6s" style="visibility: visible; animation-duration: 0.6s; animation-delay: 0.6s; animation-name: bounceIn;">
                       ...
                       <div class="tp-offer-item-content">
                          ...
                          <p>Content Management System is a software application or platform that facilitates the creation, modification, and management of digital content for websites.</p>
                       </div>
                       <!-- <div class="tp-offer-item-btn">
                          <a href="services-details.html">Read More <i class="fa-regular fa-arrow-right"></i></a>
                       </div> -->
                    ...
                    <div class="tp-contact-main mb-40">
                       ...
                       <div class="tp-contact-location-wrap d-flex align-items-center">
                          <div class="tp-contact-location">
                             ...
                             <a  class="text-black"  href="#"><i class="fa-light fa-location-dot"></i>GF-2 Dhanlaxmi Complex,<br> Vadodara   </a>
                             <a  class="text-black"  href="tel:0123456"><i class="fa-light fa-phone"></i> +919106077817</a>
                             <a  class="text-black"  href="mailto:hello@devloops.in"><i class="fa-light fa-envelope"></i>hello@devloops.in</a>
                          </div>
                          <div class="tp-contact-location ml-40">
                             <span class="tp-contact-location-title">Canada</span>
                             <a  class="text-black"  href="#"><i class="fa-light fa-location-dot"></i>Kitchener, Ontario,<br> Canada</a>
                             <a  class="text-black"  href="tel:0123456"><i class="fa-light fa-phone"></i> +919106077817</a>
                             <a  class="text-black"  href="mailto:hello@devloops.in"><i class="fa-light fa-envelope"></i>hello@devloops.in</a>
                          </div>
                       </div>
