       ...
       <div class="container" style="border:  2px solid rgb(226, 224, 224);border-radius: 20px; padding: 50px;">
          ...
          <div class="postbox-content">
             ...
             {{-- <div class="postbox-text">
                ...
                <ul>
                <li class="text-black">
                  <span style="color: #4bb589;"> Personal Information</span>: Such as your name, email address, phone number, and other contact details that you voluntarily provide to us.</li>
          ...
          <!-- <div class="postbox-blockquote">
             <blockquote>
                <div class="postbox-blockquote-thumb">
                  <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="#4bb589" class="bi bi-quote" viewBox="0 0 16 16">
