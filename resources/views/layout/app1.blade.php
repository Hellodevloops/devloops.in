               ...
               <div class="tp-header-3-top-wrap d-flex align-items-center justify-content-between">
                  <div class="tp-header-3-top-left d-flex align-items-center">
                     <div class="tp-header-3-top-left-item">
                        ...
                        <a href="contact.html">GF-2 Dhanlaxmi Complex, Subhanpura, Vadodara</a>
                     </div>
                     <div class="tp-header-3-top-left-item">
                        <span><i class="fa-solid fa-envelope"></i></span>
                        <a href="mailto:support@devloops.in"><span>support@devloops.in</span></a>
                    </div>
                       ...
                       <div class="tp-footer-widget footer-col-1 mb-40">
                          ...
                          <div class="tp-footer-widget-content">
                             ...
                             <div class="tp-footer-widget-content-list">
                                ...
                                <div class="tp-footer-widget-content-list-item">
                                   <a href="mailto:support@devloops.in"><i class="fa-light fa-envelope"></i>support@devloops.in</a>
                                </div>
                                <div class="tp-footer-widget-content-list-item">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                       <div class="tp-footer-widget tp-footer-col-2 mb-40">
                          ...
                          <div class="tp-footer-widget-link">
                             <ul>
                                <li><a href="index.html"><i class="fa-sharp fa-solid fa-plus"></i> Home</a></li>
                                <li><a href="about.html"><i class="fa-sharp fa-solid fa-plus"></i>About</a></li>
                                <li><a href="blog.html"><i class="fa-sharp fa-solid fa-plus"></i>Blog</a></li>
                                <li><a href="career.html"><i class="fa-sharp fa-solid fa-plus"></i>Career</a></li>
                                <li><a href="contact.html"><i class="fa-sharp fa-solid fa-plus"></i> Contact</a></li>
                             </ul>
                          </div>
                       </div>
                    </div>
                             ...
                             <div class="tp-footer-widget-gallery-all">
                                <div class="tp-footer-widget-gallery-single-item">
                                   <a href="#" class="tp-footer-widget-gallery-item">
                                         ...
                                         <img src="{{ asset('assets/img/footer/one/gallery/fw-g-1.jpg') }}" alt="">
                                ...
                                <div class="tp-footer-widget-gallery-single-item">
                                   <a href="#" class="tp-footer-widget-gallery-item">
                                         ...
                                         <img src="{{ asset('assets/img/footer/one/gallery/fw-g-3.jpg') }}" alt="">
                                ...
                                <div class="tp-footer-widget-gallery-single-item">
                                   <a href="#" class="tp-footer-widget-gallery-item">
                                         ...
                                         <img src="{{ asset('assets/img/footer/one/gallery/fw-g-4.jpg') }}" alt="">
                                ...
                                <div class="tp-footer-widget-gallery-single-item">
                                   <a href="#" class="tp-footer-widget-gallery-item">
                                         ...
                                         <img src="{{ asset('assets/img/footer/one/gallery/fw-g-5.jpg') }}" alt="">
                                ...
                                <div class="tp-footer-widget-gallery-single-item">
                                   <a href="#" class="tp-footer-widget-gallery-item">
                                         ...
                                         <img src="{{ asset('assets/img/footer/one/gallery/fw-g-6.jpg') }}" alt="">
