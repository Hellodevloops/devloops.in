                       ...
                       <div class="tp-management-list">
                          <div class="tp-management-item d-flex">
                             ...
                             <div class="tp-management-item-content">
                                ...
                                <p class="text-black">Facilitates seamless collaboration among teams, fostering innovation and productivity.</p>
                             </div>
                          </div>
                          <div class="tp-management-item d-flex">
                             <div class="tp-management-item-icon">
                             ...
                             <div class="tp-management-item-content">
                                ...
                                <p class="text-black">Leading to constant refinement and improved product quality.</p>
                             </div>
                          </div>
                       </div>
                    </div>
