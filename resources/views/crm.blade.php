...
@section('content')
    <main>
        ...
        <section class="breadcrumb-area breadcrumb-wrap">
            <div class="breadcrumb-bg" data-background="./assets/img/crm-bg.jpg"></div>
            <div class="container">
                    ...
                    <div class="col-lg-8">
                        <div class="tp-services-details-wrapper ml-30">
                            <div class="tp-services-details-main-thumb mb-30 w-img">
                                <img src="assets/img/crm.jpg" alt="CRM">
                            </div>
       ...
       <div class="row">
               ...
               <div class="tp-offer-item mb-40 wow bounceIn" data-wow-duration=".6s" data-wow-delay=".6s">
                   <div class="tp-offer-item-icon">
                       <svg xmlns="http://www.w3.org/2000/svg" width="75" height="75" fill="white"
                           ...
                           <path d="M6.5 5h-1V4a1 1 0 0 1 1-1h1v1h1v1H6.5V5zm1.5 0V3h1v2h-1zm4 0h-1V4a1 1 0 0 1 1-1h1v1h1v1h-1v2h-1v-2zm-5 2v6h-1v-6h1zm4 0v6h-1v-6h1zm4 0v6h-1v-6h1z" />
                       </svg>
                   </div>
                   <div class="tp-offer-item-content">
                       <h4 class="tp-offer-item-title under-line-white">Contact Management</h4>
                   </div>
               </div>
           </div>
           ...
           <div class="col-xl-3 col-lg-4 col-md-6">
               <div class="tp-offer-item mb-40 wow bounceIn" data-wow-duration=".6s" data-wow-delay=".6s">
                   ...
                   <div class="tp-offer-item-content">
                       <h4 class="tp-offer-item-title under-line-white">Appointment Scheduling</h4>
                   </div>
               </div>
           </div>
           ...
           <div class="col-xl-3 col-lg-4 col-md-6">
               <div class="tp-offer-item mb-40 wow bounceIn" data-wow-duration=".6s" data-wow-delay=".6s">
                   ...
                   <div class="tp-offer-item-content">
                       <h4 class="tp-offer-item-title under-line-white">Customer Interaction Tracking</h4>
                   </div>
               </div>
           </div>
           ...
           <div class="col-xl-3 col-lg-4 col-md-6">
               <div class="tp-offer-item mb-40 wow bounceIn" data-wow-duration=".6s" data-wow-delay=".6s">
                   ...
                   <div class="tp-offer-item-content">
                       <h4 class="tp-offer-item-title under-line-white">Sales Tracking</h4>
                   </div>
               </div>
           </div>
       </div>
           ...
           <div class="col-md-4 col-sm-6 d-flex">
               <div class="tp-service-box white-bg mb-30 d-flex flex-column">
                   ...
                   <div class="tp-service-box-content flex-grow-1">
                       ...
                       <p>Streamline scheduling and manage appointments efficiently to improve client satisfaction.</p>
                   </div>
               </div>
           </div>
           <div class="col-md-4 col-sm-6 d-flex">
               <div class="tp-service-box white-bg mb-30 d-flex flex-column">
                   ...
                   <div class="tp-service-box-content flex-grow-1">
                       ...
                       <p>Track sales metrics and generate reports to analyze and optimize your sales strategies.</p>
                   </div>
               </div>
           </div>
       </div>
            ...
            <div class="col-lg-12">
                <div class="tp-project-details-list">
                    ...
                    <p class="Text-black pb-10">
                        In today’s competitive landscape, effective Customer Relationship Management (CRM) is crucial for
                        fostering strong customer relationships and driving business growth. At Devloops International, we
                        specialize in delivering customized CRM solutions that streamline your customer interactions and
                        enhance your overall business efficiency. Our approach combines advanced CRM technology with tailored
                        strategies to ensure your customer relationships are managed effectively and your business objectives
                        are met.

                        We offer a comprehensive CRM system that covers all essential modules to support your business needs:
                    </p>
                    <ul class="Text-black pb-10">
                        <li><strong>Leads:</strong> Efficiently manage and track potential sales opportunities with our intuitive lead management system.</li>
                        <li><strong>Activities:</strong> Keep track of all interactions and activities related to your customers and prospects.</li>
                        <li><strong>Mailing:</strong> Automate and manage email campaigns to engage with your customers and prospects effectively.</li>
                        <li><strong>Quotes:</strong> Generate and manage quotes for your products and services with ease.</li>
                        <li><strong>Person & Organization:</strong> Organize and maintain detailed information about your contacts and their associated organizations.</li>
                        <li><strong>Settings:</strong> Customize CRM settings to fit your business requirements and preferences.</li>
                        <li><strong>Products:</strong> Manage and track your products and services within the CRM system.</li>
                        <li><strong>Configurations:</strong> Tailor the CRM to your specific needs with flexible configuration options.</li>
                    </ul>
                    <p class="Text-black pb-10">
                        From CRM implementation and integration to data analysis and customer engagement strategies, our team
                        is dedicated to providing solutions that help your business thrive. We also offer ongoing support and
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="tp-offer-item mb-40 wow bounceIn" data-wow-duration=".6s" data-wow-delay=".6s"
                    ...
                    <div class="tp-offer-item-content">
                        <h4 class="tp-offer-item-title under-line-white">Person & Organization Management</h4>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="tp-offer-item mb-40 wow bounceIn" data-wow-duration=".6s" data-wow-delay=".6s"
                    ...
                    <div class="tp-offer-item-content">
                        <h4 class="tp-offer-item-title under-line-white">Product Management</h4>
                    </div>
                </div>
            </div>
        </div>
